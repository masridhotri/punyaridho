...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('tamplate/dist/vendors/datatables.net-bs5/dataTables.bootstrap5.css') }}">
    <link rel="stylesheet" href="{{ asset('tamplate/dist/vendors/ti-icons/css/themify-icons.css') }}">
    <link rel="stylesheet" type="text/css" href="{{ asset('tamplate/js/select.dataTables.min.css') }}">
...
<body>
    ...
    <script src="{{ asset('tamplate/src/assets/vendors/chart.js/chart.umd.js') }}"></script>
    <script src="{{ asset('tamplate/src/assets/vendors/datatables.net/jquery.dataTables.js') }}"></script>
    <!-- <script src="assets/vendors/datatables.net-bs4/dataTables.bootstrap4.js"></script> -->
    <script src="{{ asset('tamplate/src/assets/vendors/datatables.net-bs5/dataTables.bootstrap5.js') }}"></script>
    <script src="{{ asset('tamplate/src/assets/vendors/js/dataTables.select.min.js') }}"></script>
